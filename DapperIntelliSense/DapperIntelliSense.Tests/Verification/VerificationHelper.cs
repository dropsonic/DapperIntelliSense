...
namespace DapperIntelliSense.Tests.Verification
{
	public static class VerificationHelper
	{
		...
		private static Project CreateProject(string[] sources, string language = LanguageNames.CSharp, string[] externalCode = null)
		{
			...
			var workspace = new AdhocWorkspace(CreateHostServices());
			...
			var solution = workspace.CurrentSolution
				...
				.AddMetadataReference(projectId, SystemDataCommon)
		...
		{
			//return MefHostServices.Create(
			//	MefHostServices.DefaultAssemblies.Concat(new[] { typeof(DapperCompletionProvider).Assembly }));
			var container = new ContainerConfiguration()
				.WithAssemblies(MefHostServices.DefaultAssemblies)
				.WithPart<DapperCompletionProvider>()
				.CreateContainer();
